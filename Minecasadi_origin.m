function x_opt = Minecasadi(PositionX,PositionY,Pose,voronoiX, voronoiY)
voronoiX = voronoiX';
voronoiY = voronoiY';
import casadi.*
vv=0.05;ww=0.5;
...
verticesNum=size(voronoiX,1)-1;
voronoiX=[voronoiX(:); voronoiX(2)];
voronoiY=[voronoiY(:); voronoiY(2)];

...
%FsyData = 100000000*DataTransform(Data,DataRange);
%FsyData = 1000000*Data;
%FsyData = FsyData + 0.2;
%FsyData = FsyData+0.05;
%% 连通保持控制器参数设定
R = 25; %通信半径
...
%s = surf(0:0.1:99.9,0:0.1:99.9,FsyData);
s.EdgeColor = 'none';
view(2);
title('任务区域场强图')
xlabel('x')
...
for i = 1:UAVnumber  %维诺划分的设置
    verCellHandle(i)  = patch(v(c{i},1),v(c{i},2),cellColors(i,:));
    hold on
end
%无人机轨迹
...
%% 计算小框内的连通度
BoxCenter = [27,31;51,61;71,81;71,31];
BoxRadius = [12,13;10,10;10,10;8,8];

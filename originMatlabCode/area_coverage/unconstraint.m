...
%虚拟中心画图
% virtualHandle = plot(zeros(1,UAVnumber),zeros(1,UAVnumber),'o','MarkerSize',2,'color','r');
%% 计算初始位置覆盖率
%基于虚拟中心的维诺划分
...
%     % 虚拟中心/旋转中心画图
%     set(virtualHandle,'XData',PathVirtualX(counter+1,:),'YData',PathVirtualY(counter+1,:));
    %输出维诺划分
